...
from src.driver.xbox.xbox_remote import XBoxRemote
from src.driver.xbox.xbox_info import XBoxInfo
from src.driver.screen import Screen

class XBoxDriver(BaseDriver):
    pass
	...
	"""
    def remote(self):
        return XBoxRemote(self.http_client, super().get_session())
	...
	"""
    def info(self):
        return XBoxInfo(self.http_client, super().get_session())
